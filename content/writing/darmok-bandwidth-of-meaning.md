...
Which means the thing most people assume, that a concept lands the same way whichever model you ask, is not free. It is a property you have to check, and right now almost nobody does.

## The gap is the point

Divergence is also the reason an exchange is worth having, and the clearest case I have of it started with an apology.
